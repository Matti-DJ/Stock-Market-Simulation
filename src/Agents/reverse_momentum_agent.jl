...
#=
Description: The agent trades against the market
...
"""
    The momentum trades moves with the market meaning:
        -> if the market goes up for for a set amount of times consecutively then it sells
        -> if the market goes down for a set amount of times consecutively then it buys
